...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-certificate_manager',
    download_url='https://github.com:nantic/trytond-certificate_manager.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-certificate_manager.git'
    },
    classifiers=[
